...
class ResampleTest(unittest.TestCase):
    ...
    def test_check(self):
        ...
        assert_series_equal(os.resample("BQS").count().to_pandas().iloc[10:15], ps.resample("BQS").count().iloc[10:15], check_dtype=False)
    ...
    def test_from_pandas_series_resample_param_rule_date_param_on_date_before_1970(self):
        os = orca.Series(np.repeat(1, 10000), index=orca.date_range("19600101", periods=10000, freq="D"),
                         name="resample")
        ps = pd.Series(np.repeat(1, 10000), index=pd.date_range("19600101", periods=10000, freq="D"), name="resample")
        ...
        os = orca.Series(np.repeat(1, 360000), index=orca.date_range("19600101", periods=360000, freq="ms"),
                         name="resample")
        ps = pd.Series(np.repeat(1, 360000), index=pd.date_range("19600101", periods=360000, freq="ms"),
                       name="resample")
        ...
        os = orca.Series(np.repeat(1, 2000000), index=orca.date_range("19600101", periods=2000000, freq="ms"), name="resample")
        ps = pd.Series(np.repeat(1, 2000000), index=pd.date_range("19600101", periods=2000000, freq="ms"), name="resample")
        ...
        os = orca.Series(np.repeat(1, 2000000), index=orca.date_range("19600101", periods=2000000, freq="N"),
                         name="resample")
        ps = pd.Series(np.repeat(1, 2000000), index=pd.date_range("19600101", periods=2000000, freq="N"),
                       name="resample")
