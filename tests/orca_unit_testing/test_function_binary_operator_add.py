...
class FunctionAddTest(unittest.TestCase):
    ...
    def test_function_binary_operator_add_dataframe_add_with_scalar(self):
    ...
    def test_function_binary_operator_add_dataframe_add_with_list(self):
        assert_frame_equal(self.odf.to_pandas(), self.pdf)
    ...
    def test_function_binary_operator_add_dataframe_add_with_series(self):
        assert_frame_equal(self.odf.to_pandas(), self.pdf)
