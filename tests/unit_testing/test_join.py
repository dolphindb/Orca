...
class JoinTest(unittest.TestCase):
    ...
    def test_join_from_csv_param_lsuffix_paran_rsuffix(self):
    ...
    def test_join_from_csv_param_how(self):
        # by default, how = left
    ...
    def test_join_from_csv_index_param_lsuffix_paran_rsuffix(self):
    ...
    def test_join_from_csv_index_param_on(self):
    ...
    def test_join_from_csv_index_param_lsuffix_paran_how(self):
        # by default, how = left
    ...
    def test_join_from_csv_index_param_lsuffix_paran_sort(self):
        # TODO：NOT IMPLEMENTED
    ...
    def test_join_from_dataframe_param_lsuffix_paran_rsuffix(self):
